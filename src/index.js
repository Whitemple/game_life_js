...
// // Working variant but noy optimizated
// window.addEventListener('resize', () =>{
//     if(window.innerWidth == 320){
//         console.log('Media Query Matched 320px!')
//     }
//     else if(window.innerWidth <=425){
//         console.log('Media Query Matched 425px!')
//     }
//     else if(window.innerWidth <=768){
//         console.log('Media Query Matched 768px!')
//     }
//     else if(window.innerWidth <=1024){
//         console.log('Media Query Matched 1024px!')
//     }
//     else{
//         console.log('Media Query Matched OVER 1024px!')
//     }
// })
...
let defoultArray = currentGeneration;
